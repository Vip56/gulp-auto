...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/6ea0b792a03620f38a01a6ad047956788dbca539/ui-grid/ui-grid.d.ts
declare namespace uiGrid {
    ...
    export module pagination {
        ...
        export interface IGridOptions {
            ...
            /**
             * Prevents the internal sorting from executing. Events will still be fired when the sort changes, 
             * and the sort information on the columns will be updated, allowing an external sorter 
             * (for example, server sorting) to be implemented. Defaults to false.
             * @default false
             */
